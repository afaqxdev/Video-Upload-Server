...
class Frontimage extends StatefulWidget {
  const Frontimage({super.key});

  @override
  State<Frontimage> createState() => _FrontimageState();
}

class _FrontimageState extends State<Frontimage> {
      ...
      if (watermarkedImgBytes != null) {
        ...
        return Padding(
          ...
          child: InkWell(
            ...
            child: Container(
                height: 120.0,
                //width: 140.0, // Set the width as per your requirements
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    colors: const [
                      Colors.red,
                      Color.fromARGB(255, 251, 157, 157)
                ...
                child: Center(
                  child: const Text(
                      'Front Image'),
                ) //Image.asset('images/pf.png',fit: BoxFit.cover,),
                ),
          ),
        );
      }
